...
<details>
  ...
  Т.е. можно открыть папку в MSVisual или Rider и все должно собраться, можно дабл-клик на <code>.sln</code> файл. IDE сама его откроет, и подтянет настройки. Если открыть целиком всю папку, скорее всего возникнет конфликт, между проектами (не проверял).
</details>
